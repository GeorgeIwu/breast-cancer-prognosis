 ...
 */
package neuralnet.app.analyst.wizard;

import neuralnet.Encog;
import neuralnet.EncogError;
import neuralnet.app.analyst.AnalystError;
import neuralnet.app.analyst.AnalystFileFormat;
import neuralnet.app.analyst.AnalystGoal;
import neuralnet.app.analyst.EncogAnalyst;
import neuralnet.app.analyst.missing.DiscardMissing;
import neuralnet.app.analyst.missing.HandleMissingValues;
import neuralnet.app.analyst.script.AnalystClassItem;
import neuralnet.app.analyst.script.AnalystScript;
import neuralnet.app.analyst.script.DataField;
import neuralnet.app.analyst.script.ml.ScriptOpcode;
import neuralnet.app.analyst.script.normalize.AnalystField;
import neuralnet.app.analyst.script.process.ProcessField;
import neuralnet.app.analyst.script.prop.ScriptProperties;
import neuralnet.app.analyst.script.segregate.AnalystSegregateTarget;
import neuralnet.app.analyst.script.task.AnalystTask;
import neuralnet.app.generate.TargetLanguage;
import neuralnet.ml.factory.MLMethodFactory;
import neuralnet.ml.factory.MLTrainFactory;
import neuralnet.ml.prg.EncogProgramContext;
import neuralnet.ml.prg.extension.ProgramExtensionTemplate;
import neuralnet.ml.prg.extension.StandardExtensions;
import neuralnet.neural.neat.NEATPopulation;
import neuralnet.util.arrayutil.NormalizationAction;
import neuralnet.util.csv.CSVFormat;
import neuralnet.util.file.FileUtil;

 ...
 */
package neuralnet.util.normalize.output.multiplicative;

import neuralnet.util.normalize.NormalizationError;
import neuralnet.util.normalize.input.InputField;

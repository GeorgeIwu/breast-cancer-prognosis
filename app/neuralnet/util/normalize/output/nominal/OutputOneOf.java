 ...
 */
package neuralnet.util.normalize.output.nominal;

import neuralnet.util.normalize.input.InputField;
import neuralnet.util.normalize.input.InputFieldCSVText;
import neuralnet.util.normalize.output.BasicOutputField;

 ...
 */
package neuralnet.ml.data.buffer.codec;

import neuralnet.Encog;
import neuralnet.ml.data.buffer.BufferedDataError;
import neuralnet.parse.tags.read.ReadXML;
import neuralnet.parse.tags.write.WriteXML;
	...
	public void prepareWrite(final int recordCount, final int inputSize,
		...
		try {
			...
			final InputStream is = ResourceInputStream
					.openResourceInputStream("neuralnet.data/blank.xlsx");

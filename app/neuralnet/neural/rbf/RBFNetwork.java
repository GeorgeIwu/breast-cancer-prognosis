...
import neuralnet.neural.flat.FlatNetworkRBF;
...
public class RBFNetwork extends BasicML implements MLError, MLRegression,
	...
	public void setRBFCentersAndWidthsEqualSpacing(final double minPosition,
		...
		final int expectedSideLength = (int) Math.round(cmp);
		
		if (Math.round(Math.pow(expectedSideLength, dimensions)) != totalNumHiddenNeurons) {
			throw new NeuralNetworkError(

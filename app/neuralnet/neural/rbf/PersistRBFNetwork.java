...
import neuralnet.mathutil.rbf.RadialBasisFunction;
			...
			if (section.getSectionName().equals("RBF-NETWORK")
				...
				for (final String line : section.getLines()) {
					...
					final List<String> cols = EncogFileSection
							.splitColumns(line);
					final String name = "neuralnet.engine.network.activation."
							+ cols.get(0);
					try {
				...
				for (final String line : section.getLines()) {
					...
					final List<String> cols = EncogFileSection
							.splitColumns(line);
					final String name = "neuralnet.mathutil.rbf." + cols.get(0);
					try {
						final Class<?> clazz = Class.forName(name);

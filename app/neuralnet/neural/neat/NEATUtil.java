...
import neuralnet.ml.ea.opp.CompoundOperator;
import neuralnet.ml.ea.opp.selection.TruncationSelection;
import neuralnet.ml.ea.train.basic.TrainEA;
import neuralnet.neural.hyperneat.HyperNEATCODEC;
import neuralnet.neural.neat.training.opp.*;
import neuralnet.neural.neat.training.opp.links.MutatePerturbLinkWeight;
import neuralnet.neural.neat.training.opp.links.MutateResetLinkWeight;
import neuralnet.neural.neat.training.opp.links.SelectFixed;
import neuralnet.neural.neat.training.opp.links.SelectProportion;
import neuralnet.neural.neat.training.species.OriginalNEATSpeciation;

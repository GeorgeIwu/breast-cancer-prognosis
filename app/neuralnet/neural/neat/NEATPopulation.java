...
import neuralnet.ml.ea.population.BasicPopulation;
import neuralnet.ml.ea.species.BasicSpecies;
import neuralnet.neural.NeuralNetworkError;
import neuralnet.neural.hyperneat.FactorHyperNEATGenome;
import neuralnet.neural.hyperneat.HyperNEATCODEC;
import neuralnet.neural.hyperneat.HyperNEATGenome;
import neuralnet.neural.hyperneat.substrate.Substrate;
import neuralnet.neural.neat.training.NEATGenome;
import neuralnet.neural.neat.training.NEATInnovationList;
import neuralnet.util.identity.BasicGenerateID;
import neuralnet.util.identity.GenerateID;
import neuralnet.util.obj.ChooseObject;

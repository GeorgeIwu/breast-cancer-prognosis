 ...
 */
package neuralnet.neural.freeform;
...
import neuralnet.mathutil.randomize.ConsistentRandomizer;
import neuralnet.ml.*;
import neuralnet.ml.data.MLData;
import neuralnet.ml.data.MLDataSet;
import neuralnet.ml.data.basic.BasicMLData;
import neuralnet.neural.freeform.basic.BasicActivationSummationFactory;
import neuralnet.neural.freeform.basic.BasicFreeformConnectionFactory;
import neuralnet.neural.freeform.basic.BasicFreeformLayerFactory;
import neuralnet.neural.freeform.basic.BasicFreeformNeuronFactory;
import neuralnet.neural.freeform.factory.FreeformConnectionFactory;
import neuralnet.neural.freeform.factory.FreeformLayerFactory;
import neuralnet.neural.freeform.factory.FreeformNeuronFactory;
import neuralnet.neural.freeform.factory.InputSummationFactory;
import neuralnet.neural.freeform.task.ConnectionTask;
import neuralnet.neural.freeform.task.NeuronTask;
import neuralnet.neural.networks.BasicNetwork;
import neuralnet.util.EngineArray;
import neuralnet.util.obj.ObjectCloner;
import neuralnet.util.simple.EncogUtility;

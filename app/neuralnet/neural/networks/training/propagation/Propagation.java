 ...
 */
package neuralnet.neural.networks.training.propagation;
...
import neuralnet.mathutil.IntRange;
...
import neuralnet.neural.error.ErrorFunction;
import neuralnet.neural.error.LinearErrorFunction;
import neuralnet.neural.flat.FlatNetwork;
import neuralnet.neural.networks.ContainsFlat;
import neuralnet.neural.networks.training.BatchSize;
import neuralnet.neural.networks.training.Train;
import neuralnet.util.EncogValidate;
import neuralnet.util.EngineArray;
import neuralnet.util.concurrency.DetermineWorkload;
import neuralnet.util.concurrency.EngineConcurrency;
import neuralnet.util.concurrency.MultiThreadable;
import neuralnet.util.concurrency.TaskGroup;

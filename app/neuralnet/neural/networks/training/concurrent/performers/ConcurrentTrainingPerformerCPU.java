 ...
 */
package neuralnet.neural.networks.training.concurrent.performers;

import neuralnet.ml.train.MLTrain;
import neuralnet.neural.NeuralNetworkError;
import neuralnet.neural.networks.training.concurrent.ConcurrentTrainingManager;
import neuralnet.neural.networks.training.concurrent.jobs.TrainingJob;
import neuralnet.util.Stopwatch;
